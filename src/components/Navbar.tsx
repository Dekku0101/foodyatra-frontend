...
import { MapPin, Sparkles, ChevronDown, LogOut, ArrowLeft, ArrowRight, User, Compass, Users, Dices, Utensils } from 'lucide-react';
          ...
          <div className="flex items-center gap-2 sm:gap-3">
            <motion.div whileHover={{ scale: 1.05, transition: SPRING_HOVER }} whileTap={{ scale: 0.95, transition: SPRING_TAP }}>
              <button
                ...
                className="flex items-center gap-1.5 px-3 py-2 rounded-xl glass-pill hover:border-primary/40 bg-white/5 border-white/10 transition-all text-xs font-semibold text-foreground group"
            ...
            <motion.div whileHover={{ scale: 1.05, transition: SPRING_HOVER }} whileTap={{ scale: 0.95, transition: SPRING_TAP }}>
              ...
              >
                ...
                <span className="hidden sm:inline">All Food</span>
              </button>
            </motion.div>
            ...
            {userRole === 'admin' && (
              <motion.div whileHover={{ scale: 1.05, transition: SPRING_HOVER }} whileTap={{ scale: 0.95, transition: SPRING_TAP }}>
                <button
                  ...
                  className="flex items-center gap-1.5 px-3 py-2 rounded-xl glass-pill hover:border-primary/40 bg-primary/20 border-primary/40 transition-all text-xs font-semibold text-primary"
                  title="Admin Panel"
                >
            ...
            <motion.div whileHover={{ scale: 1.05, transition: SPRING_HOVER }} whileTap={{ scale: 0.95, transition: SPRING_TAP }}>
              <button
                onClick={onLogout}
                className="flex items-center justify-center w-9 h-9 rounded-xl glass-pill hover:bg-rose-500/20 hover:border-rose-500/30 transition-colors group"
                title="Logout"
              >
